...
[ Edit ](https://docs.frappe.io/wiki/spaces/r3uvq1ch61/page/136p52jb3c)
...
Logs that can be accessed via the Desk UI _(generally searched for, from the [Awesomebar](desk.md))_. These track the operational events generally; but you can utilize their APIs to track about anything from your Frappe apps.
...
Tracking the bench commands executed, status of the jobs run by your Scheduler or [Background Jobs](guides/app-development/running-background-jobs.md) can be found in these logs.
...
Server Logs may be generated by the [bench CLI](bench.md), your process manager or the Frappe application directly. Your process managers take care of getting all the moving parts up and running for your Frappe environment as well as directing output and error streams to your log files.

Apart from the _"always running"_ default logging, you can also use [Monitor](debugging.md) to log more information about all the requests to your site.
...
Frappe Application
  ...
  * [Frappe Logging API](api/logging.md)
...
[ Previous Page Translations  ](translations.md)
