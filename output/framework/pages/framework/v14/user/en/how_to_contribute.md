...
Broadly the steps to make a change to the documentation is as follows
  ...
  2. At the bottom of the page you will find the `edit` button![](https://docs.frappe.io/assets/858adb198216.png)
  3. On clicking the Edit button you should see a UI like this![](https://docs.frappe.io/assets/6efa45a847ab.png)
  4. Now you can edit the markdown code and check the preview on the `Preview Tab`![](https://docs.frappe.io/assets/4a76d2149b89.png)
  5. If you do not want to edit markdown and want to edit via the WYSIWYG Editor click on the switcher and choose Rich-Text ![](https://docs.frappe.io/assets/4a76d2149b89.png)
  6. For uploading images:
  7. In Markdown mode
  8. Click on add attachment button to upload an image
  9. Use the copy link button to get the link copied![](https://docs.frappe.io/assets/442580eac713.png)
  ...
  16. Once submitted you will see this screen![](https://docs.frappe.io/assets/04d18dbb3532.jpg)
  ...
  20. You can also drag and drop sidebars on the edit/ new page to rearrange them(Use this only when necessary)![](https://docs.frappe.io/assets/64ba5c05b856.gif)
