...
[ Edit ](</wiki/spaces/r3uvq1ch61/page/12mmncp537>)
...
[About Workspace →](</framework/v14/user/en/desk/workspace>)

![Desktop](/files/v14-workspace.png)
...
![Awesomebar](/files/awesomebar.png) _Navigating ToDo using Awesomebar_
...
> Learn more about the [List API](</framework/v14/user/en/api/list>).
...
![Form View](/files/form-timeline.png) _Form Timeline_

> Learn more about the [Form API](</framework/v14/user/en/api/form>).
...
![Grid View](/files/configure_grid_columns.gif)
...
![Report Builder](/files/report-builder.gif) _Report Builder Features_
...
![Tree View](/files/tree-view.png) _Tree View_

## Calendar View

Calendar view can be configured for DocTypes with a start date and end date.

![Calendar View](/files/calendar-view.png) _Calendar View_
...
![Gantt View](/files/gantt-view.png) _Gantt View_
...
![Kanban View](/files/kanban-view.png)

## Dark Theme

![Dark Theme](/files/Screenshot%202022-01-18%20at%203.35.44%20PM.png)
...
![Desk Theme Modal](/files/Screenshot%202022-01-18%20at%203.47.33%20PM.png)

**Note:** You can also press CTRL + SHIFT + G to open this modal.

[ Previous Page Customizing DocTypes  ](</framework/v14/user/en/basics/doctypes/customize>) [ Next Page Reports  ](</framework/v14/user/en/desk/reports>)
