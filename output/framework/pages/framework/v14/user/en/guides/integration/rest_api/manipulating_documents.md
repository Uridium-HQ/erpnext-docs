...
By default, only the 'name' field will be returned. To add more fields, you can pass the _fields_ parameter. For example, fields=["name","country"]

  * `filters` [[(string)]]



You can filter the listing using SQL conditions by passing them in the _filters_ parameter. Each condition is an array of the format, [{doctype}, {field}, {operator}, {value}]. For example, filters=[["Customer", "country", "=", "India"]]
...
_Get at most 20 Names (IDs) of all Customers whose phone number is 4915227058038._
[code] 
...
_Create a new Lead named Mustermann._
[code] 
...
_Get the Customer with Name (ID) CUST-00001._
[code] 
