...
[ Edit ](https://docs.frappe.io/wiki/spaces/r3uvq1ch61/page/12ki6c6ktc)
...
This is a bit more restrictive given it allows you to write code directly from Desk. [Utils allowed in Server Scripts](../desk/scripting/script-api.md) and Document attributes can be accessed through this. Equivalent of the above property maybe as follows:
[code] 
...
[ Previous Page DocField  ](doctypes/docfield.md) [ Next Page Field Types ](doctypes/fieldtypes.md)
