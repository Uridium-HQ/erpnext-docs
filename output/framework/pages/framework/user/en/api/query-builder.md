...
Returns a Pypika query object which lets you build queries. Queries built using this object will be a type from `pypika.dialects`, sprinkled with some Frappe sugar. Some of its methods are:
...
This is the most preferred method to execute your queries. Every valid query has the `run` method which you may use to execute the query with.
[code] 
