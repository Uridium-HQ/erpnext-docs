...
[ Edit ](</wiki/spaces/1u8fslkdg6/page/0u8kdbhq07>)
...
[ Previous Page Database Migrations  ](</framework/user/en/database-migrations>) [ Next Page Zero* downtime migrations ](</framework/user/en/zero*_downtime_migrations>)
