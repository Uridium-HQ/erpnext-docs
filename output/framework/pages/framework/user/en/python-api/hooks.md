...
`get_web_pages_with_dynamic_routes` | Web pages with dynamic routes  
...
`on_print_pdf` | On printing  
`on_session_creation` | Session Hooks  
`extend_doctype_class` | Extend DocType Class  
