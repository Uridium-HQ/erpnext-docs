...
[ Edit ](https://docs.frappe.io/wiki/spaces/1u8fslkdg6/page/0tk170kf6k)
...
This is a bit more restrictive given it allows you to write code directly from Desk. [Utils allowed in Server Scripts](../../../v14/user/en/desk/scripting/script-api.md) and Document attributes can be accessed through this. Equivalent of the above property maybe as follows:
[code] 
...
[ Previous Page Module  ](doctypes/modules.md) [ Next Page Field Types ](doctypes/fieldtypes.md)
