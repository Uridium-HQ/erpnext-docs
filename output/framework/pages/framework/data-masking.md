...
#### Steps to Enable Data Masking
  ...
  1. Open the Doctype (in Developer Mode) or Customize Form where you want to enable masking.
  2. Select the field you want to mask.
  3. Check the Mask checkbox.
...
[code] meta.has_permlevel_access_to(fieldname=df.fieldname, df=df, permission_type="mask")
         
[/code]

  3. **Automatic Masking in Responses** Once the permission check fails, the framework automatically masks the field value before returning it. This applies to:
