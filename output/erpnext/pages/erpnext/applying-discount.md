...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0so7qc34g3>)
...
If you want to apply a discount (as a Percentage) regularly for certain quantities you'd rather use a "Pricing Rule". Read [Pricing Rule](</erpnext/pricing-rule>) documentation to learn more.
...
[ Previous Page Request for Raw Materials from Sales Order  ](</erpnext/request-for-raw-materials-from-sales-order>) [ Next Page Amending Sales Order after Submit  ](</erpnext/amending-sales-order-after-submit>)
