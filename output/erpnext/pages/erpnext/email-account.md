...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0rbv7h6n6a)
...
Before creating an Email Account, you need an [Email Domain](https://docs.frappe.io/erpnext/email-domain). However, you can skip creating an Email Domain if you're using one of the services listed below, then create [here](email-inbox.md) for set up
...
* * *
  ...
  2. Enter the email address with the domain. [Domains](https://docs.frappe.io/erpnext/email-domain) need to be created in order to create an email account. You don't need to create a domain if you're syncing an email from certain providers as listed [here](email-inbox.md).
...
If you encounter errors when configuring an email account, refer to [this page](https://docs.frappe.io/erpnext/email-error).
...
### 6\. Related Topics
  ...
  1. [Email Inbox](email-inbox.md)
  2. [Email Digest](email-digest.md)
  3. [Auto Email Reports](auto-email-reports.md)
  4. [Sending Email](sending-email.md)
  5. [Email Domain](https://docs.frappe.io/erpnext/email-domain)



[ Previous Page Email Domain ](https://docs.frappe.io/erpnext/email-domain) [ Next Page Email Template  ](email-template.md)
