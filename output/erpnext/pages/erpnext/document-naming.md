...
If the Country is USA, the format should be: CUST-USA-00001, CUST-USA-00002, ...
  ...
  4. Define the Prefix Enter the desired prefix in the Prefix field under the Naming section. Example: PSI/

  5. Set the Serial Number Start Specify the starting serial number in the field next to the prefix. Example: 5 → The first document will be named PSI/00005
