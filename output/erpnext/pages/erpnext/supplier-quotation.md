...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0rgm9jgh1m>)
...
You can make a supplier quotation from a Material Request: ![Supplier Quotation from Material Receipt](/files/supplier-quotation-from-mr.png)
...
**Buying > Purchasing > Supplier Quotation > New**.
  ...
  3. Enter the Item code, select the quantity. Rate will be fetched if you've set the Standard Buying rate for the item in [Item Price](</erpnext/item-price>). ![Supplier Quotation](/files/supplier-quotation.png)
...
### 4\. Related Topics
  ...
  2. [Supplier Group](</erpnext/supplier-group>)
  3. [Purchase Order](</erpnext/purchase-order>)
  4. [Request for Quotation](</erpnext/request-for-quotation>)



[ Previous Page Request for Quotation ](</erpnext/request-for-quotation>) [ Next Page Purchase Order ](</erpnext/purchase-order>)
