...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0s1jqqcl82)
...
![BOM in different Currency](https://docs.frappe.io/assets/3d43962b0ef0.png)
...
![BOM in different Currency](https://docs.frappe.io/assets/9d0e4afcf5e7.png)

[ Previous Page Issued Items Against Work Order ](https://docs.frappe.io/erpnext/consumed-materials-in-production) [ Next Page Managing Multi-level BOM ](managing-multi-level-bom.md)
