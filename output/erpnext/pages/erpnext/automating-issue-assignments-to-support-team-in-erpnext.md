...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0setcrkevm)
...
![](../../assets/b77fc0b5901b.gif)  
**4) Based on the rule defined in step (3), the assignments will be done automatically** These are done as in when an Issue is created or updated. Check out below GIF to see automation in action when an issue ticket's status is _updated_ :  
![](../../assets/78cddf88a015.gif)  
Note: If needed, the rule can also be disabled/updated:  
![](../../assets/0b89695e6489.png)  
...
[ Previous Page Maintenance Schedule  ](maintenance-schedule.md) [ Next Page DocType  ](doctype.md)
