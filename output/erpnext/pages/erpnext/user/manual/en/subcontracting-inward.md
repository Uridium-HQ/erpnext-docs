...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0rv9f07mgl)
...
## Prerequisites
  ...
  1. Every Customer needs to have their own warehouse (dummy) in the masters. This is done by creating a new Warehouse and setting the newly added Customer Link field. ![](../../../../../assets/f9e8f706e09b.png)
  2. While optional, we strongly recommend you to create a group warehouse which will hold all the customer warehouses in it as it will make data analysis much easier. Note that a Group Warehouse does not need the `Customer` Link field set however if your Customer has multiple warehouses, we recommend you to structure the warehouses accordingly. ![](../../../../../assets/556275390a51.png)
...
![](../../../../../assets/faeb42cafe44.png)

  4. The non-stock/service item that will be sold or billed to the Customer. The `Maintain Stock` field has to be unchecked (checked by default in ERPNext) for this. ![](../../../../../assets/7983ccb49280.png)
  5. The Finished Good to be produced needs to be marked as a Subcontracted Item



![](https://docs.frappe.io/files/image7b1ac7.png)

  6. A standard ERPNext [Bill of Materials or ‘BOM’](https://docs.frappe.io/erpnext/user/manual/en/bill-of-materials.md) for the finished good to be produced.
...
![](../../../../../assets/40e211b8e1e4.png)

## Important Notes

  1. [Stock Reservation](https://docs.frappe.io/erpnext/user/manual/en/stock-reservation.md) Entries will be created and used extensively by default in this process even if its disabled in `Stock Settings`.
  ...
  6. Using [Alternative Items](https://docs.frappe.io/erpnext/user/manual/en/item-alternative.md) in Work Orders created against Subcontracting Inward Orders is currently not supported and the checkbox is hidden for the same.
  7. While you _can_ use [Inventory Dimension](https://docs.frappe.io/erpnext/user/manual/en/inventory_dimension.md) in this process, it is not officially supported as of yet.
  8. [Continuous Raw Material Consumption](https://docs.frappe.io/erpnext/user/manual/en/manufacturing-settings.md) and [Disassembly Order](https://docs.frappe.io/erpnext/user/manual/en/disassembly-order.md) are also not supported as of yet.
...
[ Previous Page Subcontracting ](../../../subcontracting.md) [ Next Page Reports ](../../../subcontracting/reports.md)
