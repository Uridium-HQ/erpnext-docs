...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0s6s4hkv86)
...
### Uploading backup to Google Drive
  ...
  * To backup data to Google Drive, click on **Take Backup**. Backup process will run in the background and you will be notified regarding the backup status. ![](../../../../../assets/fa4da9c03aa1.gif)
...
[ Previous Page Google Maps Integration  ](https://docs.frappe.io/erpnext/google_maps) [ Next Page Upload Backups to Amazon S3 ](https://docs.frappe.io/erpnext/aws_s3)
