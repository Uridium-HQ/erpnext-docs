...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0skkqnceec>)
...
In Sales Invoice, in-words in being printed with the rounding off even though it is disabled via Global Defaults.In the Global Defaults one can always Disable Rounded Total via the following checkbox: ![](/files/OkUOjHx.png)
...
[ Previous Page Delete entries linked with GL entries ](</erpnext/delete-entries-linked-with-gl-entries>) [ Next Page Customise Cash Flow Report ](</erpnext/customise-cash-flow-report>)
