...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0siu0179g3)
...
**Price List Rate:** This option allows to pull item rates from [Price List.](item-price.md)

**Last Purchase Rate:** It will be the last Purchase (Order) Rate of an item.

[ Previous Page Managing Multi-level BOM ](managing-multi-level-bom.md) [ Next Page Material consumption  ](material_consumption.md)
