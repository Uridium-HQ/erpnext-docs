...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0rf08n8b6o)
...
![Campaign](https://docs.frappe.io/assets/30528921bc93.png)
...
When a marketing campaign generates a lead or an opportunity, you can tag the campaign while creating the [Lead](lead.md) or [Opportunity](opportunity.md). You can also tag the campaign in [Quotation](quotation.md).

This helps in assessing the effectiveness of a marketing campaign by calculating the return on investment.

![Campaign in Lead](https://docs.frappe.io/assets/f23316d5ed68.png)

### 2.2 View Leads Generated by a Campaign

  1. Click on 'View Leads' button in the campaign. [Campaign - View Leads](https://docs.frappe.io/files/campaign-view-leads.png)
  2. You will see a filtered list of leads made against the campaign.
  3. You can also create new leads against the campaign by clicking on 'New' [Campaign - New Lead](https://docs.frappe.io/files/campaign-new-lead.png)



### 2.3 Set up email schedules for Email Campaigns

If you want to carry out a campaign using emails for your leads or contacts, [Email Campaign](email-campaign.md) serves the purpose.
...
![Campaign - Email Template](https://docs.frappe.io/assets/45ff6a3055b0.png)
...
![Campaign Dashboard](https://docs.frappe.io/assets/5d8325a193c6.png)

## 3\. Related Topics

  1. [Lead](lead.md)
  2. [Opportunity](opportunity.md)
  3. [Quotation](quotation.md)
  4. [Email Campaign](email-campaign.md)



Next: [Email Campaign](email-campaign.md)

[ Previous Page Opportunity Type ](opportunity_type.md) [ Next Page CRM Settings ](crm_settings.md)
