...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0s8fk29t0d)
...
To setup a custom homepage:
  ...
  1. Create a [Web Page](web-page.md).
  2. Go to Website > Setup > Website Settings.
  3. Set Home Page as the `route` of your Web Page. ![](../../assets/0481a3d35e16.png)



[ Previous Page Website Settings  ](website-settings.md) [ Next Page Website Components ](website-components.md)
