...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0s0q2lpk51>)
...
## 2\. How to create a Bill of Materials
  ...
  10. Under the Scrap section, select the scrap Item that will be created when manufacturing and its quantity. The scrap Item can also have a Rate if it is a by-product and not waste. Skip this section if 100% of raw materials are completely utilized. If the scrap Item is the same as the Item to be manufactured, it is set as a Process Loss Item and its quantity is subtracted from the manufactured Item quantity. ![](/files/imageb61113.png)
...
[ Previous Page Manufacturing Dashboard  ](</erpnext/manufacturing-dashboard>) [ Next Page Workstation Type ](</erpnext/workstation_type>)
