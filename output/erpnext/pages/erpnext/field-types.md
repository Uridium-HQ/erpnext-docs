...
![Check Field TYpe](https://docs.frappe.io/assets/42a7022022f2.png)

#### Select

Select will be a drop-down field. You can add multiple results in the Option field, separated by row.

![Select Field Type](https://docs.frappe.io/assets/d45e967f923c.png)
...
![Table Field Type](https://docs.frappe.io/assets/5f1eae8c45b9.png)

#### Attach

Attach field allows you to browse a field from the File Manager and attach the same herein.

![Attach Field Type](https://docs.frappe.io/assets/3386d3b620b4.png)
...
![Field Type Image](https://docs.frappe.io/assets/d8520dae5e80.png)
...
![Field Type Text Editor](https://docs.frappe.io/assets/8436a1fde0c9.png)

#### Date

This field will enable you to enter the Date in this field.

![Field Type Date](https://docs.frappe.io/assets/c7a53f4eb951.png)
...
![Field Type Date and Time](https://docs.frappe.io/assets/9b9c89dbb8ff.png)
...
![Field Type Barcode](https://docs.frappe.io/assets/632ee7d8463d.png)

#### Button

This kind of field will be an action button, like Save, Submit, etc.

![Field Type Button](https://docs.frappe.io/assets/ef024050360f.png)

#### Code

If the Field Type is selected as code, you will be able to enter a Code to the field.

![Field Type Code](https://docs.frappe.io/assets/7578813e45f3.png)

#### Color

You will have the option of specifying the color for this Form.

![Field Type Colour](https://docs.frappe.io/assets/1c78b3ff3ce7.png)
...
![Field Type Column Break](https://docs.frappe.io/assets/0e6400b50ed3.png)
...
![Field Type Currency](https://docs.frappe.io/assets/c922a3d3adbc.png)
...
![Field Type Data](https://docs.frappe.io/assets/559ba56bdd89.png)
...
![Field Type Float](https://docs.frappe.io/assets/87db1fd3f5e1.png)
...
![Field Type Geolocation](https://docs.frappe.io/assets/4d6fabab14f3.png)

#### HTML

You can select the field to be an HTML field when you want the data to be entered in HTML format.

![Field Type HTML](https://docs.frappe.io/assets/039c74a59cde.png)
...
![Field Type Text](https://docs.frappe.io/assets/9df731d98060.png)

#### Markdown Editor

This field will allow you to add the text in Markup language.

![Field Type Markdown Editor](https://docs.frappe.io/assets/884289e88b17.png)

#### Password

The password field will have decoded value in it.

![Field Type Password](https://docs.frappe.io/assets/dc594d16d2f6.png)

#### Percent

You can define the field as a Percentage field which in the background will be calculated as a percentage.

![Field Type Percent](https://docs.frappe.io/assets/8b72a44b77ef.png)

#### Rating

You can define the field as a Rate field which in the background will be calculated as Rating.

![Field Type Rating](https://docs.frappe.io/assets/2e97e9aaf6e5.png)
...
![Field Type Read Only](https://docs.frappe.io/assets/5517b31ffc9e.png)

#### Section Break

Section Break is used to divide the form into multiple sections.

![Field Type Section Break](https://docs.frappe.io/assets/06444cfed20e.png)

#### Signature

You can define the field to be a Signature field wherein you can add the Digital Signature in this field.

![Screenshot 2024-08-28 at 3.01.56 PM](https://docs.frappe.io/assets/8326a757c905.png)
...
![Field Type Table MultiSelect](https://docs.frappe.io/assets/a90d033311a8.png)

#### Time

This is a Time field where you can define the Time in the field.

![Field Type Time](https://docs.frappe.io/assets/b371b29be376.png)

#### Duration

You can use the Duration field if you want to define a timespan.

![Field Type Duration](https://docs.frappe.io/assets/3b7116d7babf.png)
...
![Field Type Duration Options](https://docs.frappe.io/assets/a3e0de4f33c5.png)

This is how the duration field looks after the above changes.

![Field Type Duration](https://docs.frappe.io/assets/e2b0307a40f7.png)
