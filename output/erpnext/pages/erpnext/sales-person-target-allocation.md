...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0sdcu88s86>)
...
![Sales person target](/files/sales_person_target.png)
...
### 4\. Related Topics
  ...
  1. [Sales Persons in the Sales Transactions](</erpnext/sales-persons-in-the-sales-transactions>)
  2. [Using Sales Person in transactions](</erpnext/sales-persons-in-the-sales-transactions>)



[ Previous Page Sales Invoice without an Item ](</erpnext/sales-invoice-without-an-item>) [ Next Page Setting Company Sales Goal  ](</erpnext/setting-company-sales-goal>)
