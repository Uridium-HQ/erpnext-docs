...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0sdcu88s86)
...
![Sales person target](https://docs.frappe.io/assets/564ae25d8f40.png)
...
![Target Distribution](https://docs.frappe.io/assets/d7d27bcfa8e8.png)
...
![Target Item Group](https://docs.frappe.io/assets/bb73bb6a1044.png)
...
![Sales Person Territory Manager](https://docs.frappe.io/assets/1daa85b765ce.png)
...
![Sales Person Territory Report](https://docs.frappe.io/assets/67eb83b3536d.png)
...
![Target Distribution](https://docs.frappe.io/assets/d960c1ab5346.png)

You can link Monthly Distribution while allocating targets in Sales Person and in Territory master.

### 4\. Related Topics

  1. [Sales Persons in the Sales Transactions](sales-persons-in-the-sales-transactions.md)
  2. [Using Sales Person in transactions](sales-persons-in-the-sales-transactions.md)



[ Previous Page Sales Invoice without an Item ](sales-invoice-without-an-item.md) [ Next Page Setting Company Sales Goal  ](setting-company-sales-goal.md)
