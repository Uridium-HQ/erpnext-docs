...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0t5sl5giak>)
...
In a Work Order, the Operations and Workstations are fetched from the BOM of an Item. For ease of use, you should ensure that the [Routing](</erpnext/routing>) is configured in the BOM.
...
![Quality Inspection Against Job Card](/files/qi-against-job-card.png) ![Quality Inspection link in Job Card](/files/qi-link-in-job-card.png)

For more details, refer the [Quality Inspection](</erpnext/quality-inspection>) page.

[ Previous Page Work Order ](</erpnext/work-order>) [ Next Page Plant Floor ](</erpnext/plant-floor>)
