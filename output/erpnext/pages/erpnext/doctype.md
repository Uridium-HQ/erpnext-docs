...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0t7foadl14>)
...
![DocType Tree View](/files/doctype-treeview.png)
  ...
  1. **Quick Entry** : You can select if you want a Quick Entry to be made for this DocType. This will allow you to enter only a few mandatory details and save the DocType, so that a Quick Entry is made. For example, check Quick Entry in [Journal Entry](</erpnext/journal-entry#11-quick-entry>).
  2. **Track Changes** : You can select this option if you want to maintain a log of the changes made to each Form. Check Out [Document Versioning](</erpnext/document-versioning>) for more understanding on this.
...
[ Previous Page Automating Issue Assignments in ERPNext ](</erpnext/automating-issue-assignments-to-support-team-in-erpnext>) [ Next Page Naming Series  ](</erpnext/naming-series>)
