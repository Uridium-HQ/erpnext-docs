...
[ Edit ](</wiki/spaces/24hrpr6es9/page/0rpdisk0e9>)
...
In ERPNext, Tax Withholding Categories for most cases are available by default, however, you can create more if needed.
  ...
  4. Enter a Tax Withholding Rate against a [Fiscal Year](</erpnext/fiscal-year>).
...
![Tax Withholding Category in Purchase Invoice](/files/withheld-tax-calculation-in-purchase-invoice.png) 2\. To see the effect of Cumulative threshold, let's create an invoice with of amount 10,000 and submit it.
...
![Tax Withholding Payment Entry](/files/Tax-Withholding-Payment%20Entry.png)
...
![TCS in Customer](/files/tcs-eligible-customer.png) 2\. Let's create an invoice for 50 Lakhs against the eligible customer. Saving the invoice automatically calculates tax and appends it in the taxes table.
...
[ Previous Page Sales Taxes and Charges Template  ](</erpnext/sales-taxes-and-charges-template>) [ Next Page Sales Invoice ](</erpnext/sales-invoice>)
