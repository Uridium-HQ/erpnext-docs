...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0sn40ofr8n)
...
Let's assume that we need to enable Document Versioning for Purchase Order.
  ...
  3. You shall be directed to the [Customize Form](customize-form.md) page for Purchase Order.
  4. Check the field "Track changes" in the Properties. [Document Versioning](https://docs.frappe.io/files/using-document-versioning-2.gif)
