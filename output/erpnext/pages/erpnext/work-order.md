...
[ Edit ](https://docs.frappe.io/wiki/spaces/24hrpr6es9/page/0t5e26n6ue)
...
The **Work Order** can be generated from the [Production Plan](production-plan.md) based on Sales Orders.
...
A Work Order can also be directly created from a [Sales Order](sales-order.md).
...
The Source Warehouse can be changed for the raw material items used here. The default Warehouse can be set at the Item level in the [Item](item.md) master or globally in [Stock Settings](stock-settings.md).

  * **Required Quantity** : This will be calculated automatically based on the [Bill Of Materials](bill-of-materials.md).
...
Materials can be transferred against a Work Order or a Job Card. This is usually fetched from the [Bill Of Materials](bill-of-materials.md), but you can change it in the Work Order also.
...
When a Work Order is created from a [Material Request](material-request.md), it'll be shown here.
...
### 3.5 Transferring Materials for Manufacturing
  ...
  * Click on 'Start'. Once you click on Start, Job Cards will be created for the [Operations](job-card.md) involved.
...
To know more about Job Cards, visit [this page](job-card.md).
...
[ Previous Page Production Plan ](production-plan.md) [ Next Page Job Card  ](job-card.md)
